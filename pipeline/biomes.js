...
const BIOMES = {
  ...
  biblioteca: { suelo: '#625f58', pared: '#9a927f', detalle: '#66513b', luz: '#e6dfc8', fondo: '#090806', descripcion: 'una biblioteca de salas abiertas, corredores anchos y estanterías casi vacías' },
  recreativo: { suelo: '#4f465b', pared: '#80758c', detalle: '#d05f91', luz: '#74e0da', fondo: '#090710', descripcion: 'un recinto recreativo de pistas, máquinas y zonas de juego' },
  cementerio: { suelo: '#444b3f', pared: '#747970', detalle: '#8e8b79', luz: '#b9c1ad', fondo: '#070906', descripcion: 'un cementerio abierto de senderos, lápidas y mausoleos' },
