...
(function () {
  const CHANGELOG = [
    { v: 'v30.8', cambios: [
      ...
      'Los caminos de regreso conservan la forma de entrada: puerta, ventana o caminata; puertas y ventanas siempre quedan apoyadas en una pared real.',
      'Las caídas, el no-clip, la muerte y los teletransportes ya no inventan una puerta de regreso.',
